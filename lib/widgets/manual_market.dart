  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SearchBloc, SearchState>(
      builder: (context, state) {
        return state.displayManualMarker ? const _ManualMarketBody() : const SizedBox();
      },
    );
  }
}
            ...
            child: FadeInUp(
              ...
              child: MaterialButton(
                ...
                onPressed: () async {
                  ...
                  showLoadingMesssage(context);

                  final destination = await searchBloc.getCoorsStarToEnd(start, end);
